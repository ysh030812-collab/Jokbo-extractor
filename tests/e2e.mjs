...
const inputs = ['2020 감면 기말 풀이.pdf', '2023 감면 기말 풀이.pdf', '2023 감면 기말.docx',
  '2022 감면 기말.docx', '2024 호흡기계.docx', '2021 감면 기말.pdf'];
...
await pg.waitForFunction((n) => document.querySelectorAll('#fl .fi').length === n, inputs.length - 1);
...
await pg.waitForFunction((n) => document.querySelectorAll('#fl .fi').length === n, inputs.length);
...
const answer = JSON.stringify([
  ...
  { id: '2023-기말-감면-87', verdict: 'solvable', answer: '3', pages: '5', why: '시험지 DOCX — 정답 선지를 짚어 준다' },
  { id: '2022-기말-감면-144', verdict: 'solvable', pages: '6', why: '시험지 DOCX 쪽' },
  { id: '2024-호흡기계-106', verdict: 'solvable', pages: '2', why: '중간/기말 구분이 없는 시험' },
  { id: '2021-기말-감면-2', verdict: 'solvable', answer: '1', pages: '7', why: '시험지 PDF — 표를 그대로 오려 붙인다' },
  { id: '2021-기말-감면-4', verdict: 'solvable', answer: '5', pages: '8', why: '시험지 PDF — 그림을 그대로 오려 붙인다' },
